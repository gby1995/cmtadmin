var BMapLib = window.BMapLib = BMapLib || {}; (function() {
    ...
    d.prototype.open = function() {
        ...
        var g = function(q) {
            ...
            h._bind.x = q.pageX || q.clientX || 0;
            h._bind.y = q.pageY || q.clientY || 0;
            h._points.push(n);
            h._addSecPoint(n);
        ...
        var f = function(p) {
            ...
            if (h._paths.length > 0) {
                ...
                if (typeof h._bind.initX == "undefined") {
                    h._bind.x = p.pageX || p.clientX || 0;
                    h._bind.y = p.pageY || p.clientY || 0;
                    h._bind.initX = l;
                    h._bind.initY = k
                }
    ...
    var a = {
        ...
        getDrawPoint: function(h, j) {
            h = window.event || h;
            var f = h.pageX || h.clientX || 0;
            var i = h.pagey || h.clientY || 0;
