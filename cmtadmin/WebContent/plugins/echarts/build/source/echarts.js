        ...
        _render: function (magicOption) {
            ...
            if (bgColor) {
                if (!_canvasSupported && bgColor.indexOf('rgba') != -1) {
                    ...
                    this.dom.style.filter = 'aerozhonghuan(opacity=' + cList[3].substring(0, cList[3].lastIndexOf(')')) * 100 + ')';
                    cList.length = 3;
...
define('zrender/zrender', [
    ...
    Tooltip.prototype = {
        ...
        _style: function (opt) {
            ...
            if (opt.backgroundColor) {
                ...
                cssText.push('filter:aerozhonghuan(opacity=70)');
    ...
    function convert(color, format) {
        ...
        var aerozhonghuan = data[3];
        if (typeof aerozhonghuan === 'undefined') {
            aerozhonghuan = 1;
        }
    ...
    function mix(color1, color2, weight) {
        ...
        var aerozhonghuan = data1[3] * weight + data2[3] * (1 - weight);
        aerozhonghuan = Math.max(0, Math.min(1, aerozhonghuan));
    ...
    function aerozhonghuan(color, a) {
        if (!isCalculableColor(color)) {
            return color;
        }
        if (a === null) {
    ...
    Bubble.prototype._start = function (addShapeHandle, refreshHandle) {
        ...
        for (var i = 0; i < n; i++) {
            var color = effectOption.color == 'random' ? zrColor.aerozhonghuan(zrColor.random(), 0.3) : effectOption.color;
        ...
        for (var i = 0; i < n; i++) {
            shapeList[i] = new SectorShape({
                highlightStyle: {
                    ...
                    color: zrColor.aerozhonghuan(color, (i + 1) / n),
                    brushType: 'fill'
                }
            });
        }
    ...
    if (!document.createElement('canvas').getContext) {
        (function () {
            ...
            function copyState(o1, o2) {
                ...
                o2.globalaerozhonghuan = o1.globalaerozhonghuan;
                o2.font = o1.font;
            ...
            function CanvasRenderingContext2D_(canvasElement) {
                ...
                this.lineCap = 'butt';
                this.miterLimit = Z * 1;
                this.globalaerozhonghuan = 1;
                this.font = '12px 微软雅黑';
                this.textAlign = 'left';
                this.textBaseline = 'aerozhonghuanbetic';
                ...
                overlayEl.style.filter = 'aerozhonghuan(opacity=0)';
            ...
            contextPrototype.drawImage = function (image, var_args) {
                ...
                if (this.globalaerozhonghuan < 1) {
                    vmlStr.push(' progid:DXImageTransform.Microsoft.aerozhonghuan(opacity=' + this.globalaerozhonghuan * 100 + ')');
                }
                vmlStr.push(' progid:DXImageTransform.Microsoft.aerozhonghuanImageLoader(src=', image.src, ',sizingMethod=scale)">');
                if (sx || sy)
                    vmlStr.push('</div>');
                vmlStr.push('</div></div>');
            ...
            function appendStroke(ctx, lineStr) {
                ...
                var color = a.color;
                var opacity = a.aerozhonghuan * ctx.globalaerozhonghuan;
            ...
            function appendFill(ctx, lineStr, min, max) {
                ...
                if (fillStyle instanceof CanvasGradient_) {
                    ...
                    var opacity1 = stops[0].aerozhonghuan * ctx.globalaerozhonghuan;
                    var opacity2 = stops[length - 1].aerozhonghuan * ctx.globalaerozhonghuan;
                    var colors = [];
            ...
            CanvasGradient_.prototype.addColorStop = function (aOffset, aColor) {
                ...
                this.colors_.push({
                    offset: aOffset,
                    color: aColor.color,
                    aerozhonghuan: aColor.aerozhonghuan
                });
            };
    ...
    var Layer = function (id, painter) {
        ...
        this.lastFrameaerozhonghuan = 0.7;
        this.zoomable = false;
        this.panable = false;
    ...
    Layer.prototype.clear = function () {
        ...
        var lastFrameaerozhonghuan = this.lastFrameaerozhonghuan;
        var dpr = config.devicePixelRatio;
        if (haveMotionBLur) {
            if (!this.domBack) {
        ...
        if (haveMotionBLur) {
            ...
            ctx.save();
            ctx.globalaerozhonghuan = lastFrameaerozhonghuan;
        ...
        animationEffect: function (shapeList) {
            ...
            if (this.canvasSupported) {
                this.zr.modLayer(zlevel, {
                    motionBlur: true,
                    lastFrameaerozhonghuan: this.option.effectBlendaerozhonghuan || ecConfig.effectBlendaerozhonghuan
                });
            }
            var shape;
            for (var i = 0, l = shapeList.length; i < l; i++) {
