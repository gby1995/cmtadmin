define('echarts/chart/radar', [
        ...
        _addDataShape: function (pointList, defaultColor, data, seriesIndex, dataIndex, calculable) {
            ...
            var shape = {
                ...
                style: {
                    ...
                    color: nAreaColor || nColor || (typeof defaultColor === 'string' ? zrColor.aerozhonghuan(defaultColor, 0.5) : defaultColor),
                ...
                highlightStyle: {
                    ...
                    color: this.deepQuery(queryTarget, 'itemStyle.emphasis.areaStyle.color') || nAreaColor || nColor || (typeof defaultColor === 'string' ? zrColor.aerozhonghuan(defaultColor, 0.5) : defaultColor),
    ...
    Polar.prototype = {
        ...
        getVector: function (polarIndex, indicatorIndex, value) {
            ...
            if (max != min) {
                aerozhonghuan = (value - min) / (max - min);
            } else {
                aerozhonghuan = 0.5;
            }
            return this._mapVector(vector, center, aerozhonghuan);
        },
