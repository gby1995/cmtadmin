        ...
        if (body.hasClass("page-footer-fixed") === true && body.hasClass("page-sidebar-fixed") === false) {
            ...
            if (body.hasClass('page-sidebar-fixed')) {
                ...
                if (App.getViewPort().width < resBreakpointMd) {
                  ...
                  //page-sidebar opened, iframe get new height  @zhangxiu 2016/7/26
	          	 	var neg = $('.content-tabs').outerHeight();
	          	 	var iframeParent = height - neg;
				 	$("#content-main").css('height',iframeParent);
				 	$(".mainCont-wrapper").css('height',iframeParent);
                }
