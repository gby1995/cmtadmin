    ...
    if (!e.WebVideoCtrl) {
        var t = function() {
            ...
            e.GetHttpInfo = function(e, t) {
                ...
                st.prototype.processCallback(e, t)
            }
            ,
            ...
            var Z = function() {
              ...
              , k = function() {
                for (var e = arguments[0], t = 1; arguments.length > t; t++)
              ...
              , U = function(e) {
                ...
                if (K(e))
                    ...
                    for (var o = j(e), i = !1, a = 0; o.length > a; a++)
                        if (o[a].ipv4 == e.szIP || o[a].ipv6 == e.szIP) {
                            i = !0;
                            break
                        }
                    i ? r = V(e) : (r = O(e),
                    -1 == r.iRtspPort && -1 == r.iDevicePort && (r = V(e))),
                    t = r.iRtspPort,
                    s = r.iHttpPort,
                    n = r.iDevicePort
                }
              ...
              , Y = function(e) {
                e.oStreamCapa.bObtained || e.oProtocolInc instanceof nt && (G == e.szDeviceType || X == e.szDeviceType || H == e.szDeviceType ? e.oProtocolInc.getStreamChannels(e, {
                    async: !1,
                    success: function(t) {
            ...
            this.I_InsertOBJECTPlugin = function(t) {
                return _(t) || (a.szContainerID = t),
                null == document.getElementById(a.szContainerID) ? -1 : null != document.getElementById(o) || 0 != document.getElementsByName(o).length ? -1 : (document.getElementById(a.szContainerID).innerHTML = E(),
                u = I.browser().msie ? document.getElementById(o) : document.getElementsByName(i)[0],
                null == u && null == u.object ? -1 : ("object" == typeof e.attachEvent && I.browser().msie && (u.attachEvent("GetSelectWndInfo", GetSelectWndInfo),
                u.attachEvent("ZoomInfoCallback", ZoomInfoCallback),
                u.attachEvent("GetHttpInfo", GetHttpInfo),
                u.attachEvent("PluginEventHandler", PluginEventHandler),
                u.attachEvent("RemoteConfigInfo", RemoteConfigInfo)),
                B(),
                0))
            }
            ,
            this.I_WriteOBJECT_XHTML = function() {
                return document.writeln(E()),
                u = I.browser().msie ? document.getElementById(o) : document.getElementsByName(i)[0],
                null == u && null == u.object ? -1 : (I.browser().msie && (u.attachEvent("GetSelectWndInfo", GetSelectWndInfo),
                u.attachEvent("ZoomInfoCallback", ZoomInfoCallback),
                u.attachEvent("GetHttpInfo", GetHttpInfo),
                u.attachEvent("PluginEventHandler", PluginEventHandler)),
                B(),
            ...
            this.I_SetLocalCfg = function(e) {
                ...
                n = u.HWP_SetLocalConfig(I.toXMLStr(m)),
                n ? 0 : -1
            }
            ;
            var Q = function(e, t, s, n, r, o, i) {
                var a = {
                    protocol: t,
                    success: null,
                    error: null
                ...
                I.extend(a, {
                    success: function(a) {
                        var u = new et;
                        u.szIP = e,
                        2 == t ? (u.szHttpProtocol = "https://",
                        u.iHttpsPort = s) : (u.szHttpProtocol = "http://",
                        u.iHttpPort = s),
                        u.iCGIPort = s,
                        u.szAuth = n,
                        u.iDeviceProtocol = r,
            ...
            this.I_StartRealPlay = function(e, t) {
                ...
                -1 != n) {
                    ...
                    i = "http://",
                    d = h.iStreamType - 1,
                    u = h.iChannelID <= f.iAnalogChannelNum ? h.iChannelID : f.oStreamCapa.iIpChanBase + parseInt(h.iChannelID, 10) - f.iAnalogChannelNum - 1,
                    P = !0,
                    _(h.iPort) ? "https://" == f.szHttpProtocol ? (-1 == f.iHttpPort && (f.iHttpPort = U(f).iHttpPort),
                    ...
                    d = h.iStreamType,
                    u = h.iChannelID,
                    _(h.iPort) || (f.iRtspPort = h.iPort),
                    -1 == f.iRtspPort && (f.iRtspPort = U(f).iRtspPort),
                    a = f.iRtspPort),
                    -1 == a)
                        return Z("获取端口号失败"),
                        r;
            ...
            this.I_Stop = function(e) {
                ...
                if (-1 != t) {
                    var n = p[t];
                    n.bRecord && u.HWP_StopSave(n.iIndex),
                    n.bSound && u.HWP_CloseSound(),
                    n.bEZoom && u.HWP_DisableZoom(n.iIndex),
                    s = u.HWP_Stop(e),
                    0 == s && p.splice(t, 1)
                }
                return s
            ...
            this.I_SetVolume = function(e, t) {
                ...
                return -1 != n && (s = u.HWP_SetVolume(t, e)),
                s
            }
            ,
            this.I_CapturePic = function(e, t) {
                ...
                var s = this.findWndIndexByIndex(t)
                  , n = -1;
                return -1 != s && (n = u.HWP_CapturePicture(t, e)),
                n
            }
            ,
            this.I_StartRecord = function(e, t) {
                ...
                if (-1 != s) {
                    var r = p[s];
                    r.bRecord || (n = u.HWP_StartSave(t, e),
                    0 == n && (r.bRecord = !0))
                }
                return n
            }
            ...
            this.I_StopVoiceTalk = function() {
                for (var e = u.HWP_StopVoiceTalk(), t = 0, s = l.length; s > t; t++)
                    if (l[t].bVoiceTalk) {
                        l[t].bVoiceTalk = !1;
                        break
                    }
            ...
            this.I_EnableEZoom = function(e) {
                ...
                if (-1 != t) {
                    var n = p[t];
                    n.bEZoom || (s = u.HWP_EnableZoom(e, 0),
                    0 == s && (n.bEZoom = !0))
                }
                return s
            }
            ...
            this.I_Enable3DZoom = function(e) {
                ...
                if (-1 != t) {
                    var n = p[t];
                    n.b3DZoom || (s = u.HWP_EnableZoom(e, 1),
                    0 == s && (n.b3DZoom = !0))
                }
                return s
            }
            ...
            this.I_StartPlayback = function(e, t) {
                ...
                -1 != n) {
                    ...
                    if (h == R && P.oStreamCapa.bSupportShttpPlay ? (o = _(d.oTransCodeParam) ? P.oProtocolInc.CGI.startShttpPlayback : P.oProtocolInc.CGI.startTransCodePlayback,
                    i = "http://",
                    u = d.iChannelID <= P.iAnalogChannelNum ? d.iChannelID : P.oStreamCapa.iIpChanBase + parseInt(d.iChannelID, 10) - P.iAnalogChannelNum - 1,
                    _(d.iPort) ? "https://" == P.szHttpProtocol ? (-1 == P.iHttpPort && (P.iHttpPort = U(P).iHttpPort),
                    a = P.iHttpPort) : a = P.iCGIPort : (P.iHttpPort = d.iPort,
                    a = d.iPort)) : (o = P.oProtocolInc.CGI.startPlayback,
                    i = "rtsp://",
                    u = 100 * d.iChannelID + 1,
                    _(d.iPort) || (P.iRtspPort = d.iPort),
                    -1 == P.iRtspPort && (P.iRtspPort = U(P).iRtspPort),
                    a = P.iRtspPort),
                    -1 == a)
                        return Z("获取端口号失败"),
                        r;
            ...
            this.I_Frame = function(e) {
                ...
                if (-1 != t) {
                    var n = p[t]
                      , r = n.iPlayStatus;
                    (r == x || r == z) && (s = u.HWP_FrameForward(e),
                    0 == s && (n.iPlayStatus = z))
                }
                return s
            }
            ...
            this.I_Pause = function(e) {
                ...
                if (-1 != t) {
                    var n = p[t]
                      , r = n.iPlayStatus;
                    r == x ? (s = u.HWP_Pause(e),
                    0 == s && (n.iPlayStatus = T)) : r == D && (s = u.HWP_Pause(e),
                    0 == s && (n.iPlayStatus = A))
                }
                return s
            }
            ...
            this.I_Resume = function(e) {
                ...
                if (-1 != t) {
                    var n = p[t]
                      , r = n.iPlayStatus;
                    r == T || r == z ? (s = u.HWP_Resume(e),
                    0 == s && (n.iPlayStatus = x)) : r == A && (s = u.HWP_Resume(e),
                    0 == s && (n.iPlayStatus = D))
                }
                return s
            }
            ...
            this.I_CheckPluginInstall = function() {
                ...
                if (t.msie)
                    ...
                    for (var n = 0, r = navigator.mimeTypes.length; r > n; n++)
            ...
            this.I_RemoteConfig = function(e, t) {
                ...
                -1 != s) {
                    ...
                    if (-1 == o.iDevicePort)
                        if (-1 == i.iDevicePort) {
                            if (i.iDevicePort = U(i).iDevicePort,
                            r = i.iDevicePort,
                            -1 == r)
                                return n
                        } else
            ...
            this.I_ChangeWndNum = function(e) {
                return isNaN(parseInt(e, 10)) ? -1 : (u.HWP_ArrangeWindow(e),
                0)
            }
            ,
            ...
            st.prototype.m_httpRequestSet = [],
            st.prototype.setRequestParam = function(e) {
                I.extend(this.options, e)
            }
            ,
            st.prototype.submitRequest = function() {
                var e = this.getHttpMethod(this.options.type)
                  , t = null;
                if (this.options.async) {
                    var s = u.HWP_SubmitHttpRequest(e, this.options.url, this.options.auth, this.options.data, this.options.timeout);
                    -1 != s && (t = {
                        iRequestID: s,
            ...
            ,
            st.prototype.getHttpMethod = function(e) {
                var t = {
                    GET: 1,
                    POST: 2,
                    PUT: 5,
            ...
            ,
            st.prototype.processCallback = function(e, t) {
                for (var s = null, n = 0; this.m_httpRequestSet.length > n; n++)
            ...
            ,
            st.prototype.httpDataAnalyse = function(e, t) {
                var s = ""
                  , n = 0;
                "" == t || _(t) ? e.funErrorCallback() : (n = parseInt(t.substring(0, 3)),
            ...
            nt.prototype.login = function(e, t, n, r) {
                    ...
                    I.extend(a, {
                        success: function(e) {
                            ...
                            for (var o = s.$XML(e).find("InputProxyChannelStatus", !0), i = 0, a = o.length; a > i; i++) {
                                ...
                                n.push("<proxyProtocol>" + s.$XML(u).find("proxyProtocol").eq(0).text() + "</proxyProtocol>"),
                                n.push("<addressingFormatType>" + s.$XML(u).find("addressingFormatType").eq(0).text() + "</addressingFormatType>"),
                                n.push("<ipAddress>" + s.$XML(u).find("ipAddress").eq(0).text() + "</ipAddress>"),
                                n.push("<managePortNo>" + s.$XML(u).find("managePortNo").eq(0).text() + "</managePortNo>"),
                                n.push("<srcInputPort>" + s.$XML(u).find("srcInputPort").eq(0).text() + "</srcInputPort>"),
                                n.push("<userName>" + I.escape(s.$XML(u).find("userName").eq(0).text()) + "</userName>"),
                                n.push("<streamType>" + s.$XML(u).find("streamType").eq(0).text() + "</streamType>"),
                                n.push("<online>" + s.$XML(u).find("online").eq(0).text() + "</online>"),
                                n.push("<name>" + I.escape(r[c]) + "</name>"),
                                n.push("</sourceInputPortDescriptor>"),
                                n.push("</InputProxyChannelStatus>")
                            }
                            n.push("</InputProxyChannelStatusList>"),
            ...
            nt.prototype.startRealPlay = function(e, t) {
                var s = 100 * t.iChannelID + t.iStreamType
                  , n = ""
                  , r = e.szIP;
                "rtsp://" === t.urlProtocol && (r = W(r)),
                n = t.bZeroChannel ? k(t.cgi.zeroChannels, t.urlProtocol, r, t.iPort, s) : k(t.cgi.channels, t.urlProtocol, r, t.iPort, s);
                var o = u.HWP_Play(n, e.szAuth, t.iWndIndex, "", "");
                if (0 == o) {
                    var i = new tt;
            ...
            ,
            nt.prototype.ptzAutoControl = function(e, t, s, n) {
                var r = s.iChannelID
                  , o = ""
                  , i = "";
                if (n.iPTZSpeed = 7 > n.iPTZSpeed ? 15 * n.iPTZSpeed : 100,
                t && (n.iPTZSpeed = 0),
                e.szDeviceType != X)
                    o = e.iAnalogChannelNum >= r ? k(this.CGI.ptzAutoControl.analog, e.szHttpProtocol, e.szIP, e.iCGIPort, s.iChannelID) : s.bShttpIPChannel ? k(this.CGI.ptzAutoControl.digital, e.szHttpProtocol, e.szIP, e.iCGIPort, s.iChannelID - e.oStreamCapa.iIpChanBase + 1 + e.iAnalogChannelNum) : k(this.CGI.ptzAutoControl.digital, e.szHttpProtocol, e.szIP, e.iCGIPort, s.iChannelID),
            ...
            ,
            nt.prototype.ptzControl = function(e, t, s, n) {
                var r = s.iChannelID
                  , o = "";
                s.bPTZAuto && this.ptzAutoControl(e, !0, s, {
                    iPTZSpeed: 0
                }),
                n.iPTZSpeed = t ? 0 : 7 > n.iPTZSpeed ? 15 * n.iPTZSpeed : 100;
                var i = [{}, {
                    pan: 0,
                    tilt: n.iPTZSpeed
                }, {
                ...
                case 15:
                    ...
                    break;
                default:
                    return _(n.error) && n.error(),
                    void 0
                }
                o = u != this.CGI.ptzFocus && u != this.CGI.ptzIris || e.szDeviceType != G && e.szDeviceType != X && e.szDeviceType != H ? e.iAnalogChannelNum >= r ? k(u.analog, e.szHttpProtocol, e.szIP, e.iCGIPort, s.iChannelID) : s.bShttpIPChannel ? k(u.digital, e.szHttpProtocol, e.szIP, e.iCGIPort, s.iChannelID - e.oStreamCapa.iIpChanBase + 1 + e.iAnalogChannelNum) : k(u.digital, e.szHttpProtocol, e.szIP, e.iCGIPort, s.iChannelID) : k(u.ipc, e.szHttpProtocol, e.szIP, e.iCGIPort, s.iChannelID);
                var c = new st
                  , l = {
                    type: "PUT",
                    url: o,
            ...
            ,
            nt.prototype.recordSearch = function(e, n) {
                var r = ""
                  , o = ""
                  , i = n.iChannelID
                ...
                o = "<?xml version='1.0' encoding='UTF-8'?><CMSearchDescription><searchID>" + new t + "</searchID>" + "<trackList><trackID>" + (100 * i + 1) + "</trackID></trackList>" + "<timeSpanList>" + "<timeSpan>" + "<startTime>" + a + "</startTime>" + "<endTime>" + u + "</endTime>" + "</timeSpan>" + "</timeSpanList>" + "<maxResults>40</maxResults>" + "<searchResultPostion>" + n.iSearchPos + "</searchResultPostion>" + "<metadataList>" + "<metadataDescriptor>//metadata.ISAPI.org/VideoMotion</metadataDescriptor>" + "</metadataList>" + "</CMSearchDescription>";
                var c = new st
                  , l = {
                    type: "POST",
                    url: r,
            ...
            nt.prototype.startPlayback = function(e, t) {
                var s = t.iWndIndex
                  ...
                  , r = t.szEndTime
                  , o = e.szIP;
                "rtsp://" === t.urlProtocol && (o = W(o));
                var i = k(t.cgi, t.urlProtocol, o, t.iPort, t.iChannelID, n, r);
                if (!_(t.oTransCodeParam)) {
                    var a = J(t.oTransCodeParam);
                    if ("" == a)
                        return -1;
                    u.HWP_SetTrsPlayBackParam(s, a)
                }
                var c = u.HWP_Play(i, e.szAuth, s, n, r);
                if (0 == c) {
                    var l = new tt;
                    l.iIndex = s,
                    l.szIP = e.szIP,
                    l.iChannelID = t.iChannelID,
                    l.iPlayStatus = x,
                    p.push(l)
                }
                return c
            ...
            nt.prototype.reversePlayback = function(e, t) {
                ...
                "rtsp://" === t.urlProtocol && (o = W(o));
                var i = k(t.cgi, t.urlProtocol, o, t.iPort, t.iChannelID, n, r)
                  , a = u.HWP_ReversePlay(i, e.szAuth, s, n, r);
                if (0 == a) {
                    var c = new tt;
                    c.iIndex = s,
                    c.szIP = e.szIP,
            ...
            ,
            nt.prototype.restore = function(e, t, s) {
            ...
            ,
            nt.prototype.set3DZoom = function(e, t, n, r) {
                var o = t.iChannelID
                  , i = "";
                i = e.iAnalogChannelNum >= o ? k(this.CGI.set3DZoom, e.szHttpProtocol, e.szIP, e.iCGIPort, t.iChannelID) : t.bShttpIPChannel ? k(this.CGI.set3DZoom, e.szHttpProtocol, e.szIP, e.iCGIPort, t.iChannelID - e.oStreamCapa.iIpChanBase + 1 + e.iAnalogChannelNum) : k(this.CGI.set3DZoom, e.szHttpProtocol, e.szIP, e.iCGIPort, t.iChannelID);
                var a = I.loadXML(n)
            ...
            ,
            nt.prototype.getSDKCapa = function(e, t) {
            ...
            rt.prototype.login = function(e, t, n, r) {
                var o = 2 == r.protocol ? "https://" : "http://"
                  , i = k(this.CGI.login, o, e, t)
                  , a = new st
                  , u = {
            ...
            ,
            rt.prototype.getAudioInfo = function(e, t) {
                var s = k(this.CGI.getAudioInfo, e.szHttpProtocol, e.szIP, e.iCGIPort)
                  , n = new st
                  , r = {
                    type: "GET",
            ...
            ,
            rt.prototype.getDeviceInfo = function(e, t) {
                var n = k(this.CGI.getDeviceInfo, e.szHttpProtocol, e.szIP, e.iCGIPort)
                  , r = new st
                  , o = {
                    type: "GET",
            ...
            ,
            rt.prototype.getAnalogChannelInfo = function(e, t) {
                var n = k(this.CGI.getAnalogChannelInfo, e.szHttpProtocol, e.szIP, e.iCGIPort)
                  , r = new st
                  , o = {
                    type: "GET",
            ...
            ,
            rt.prototype.getDigitalChannel = function(e, t) {
                var n = k(this.CGI.getDigitalChannel, e.szHttpProtocol, e.szIP, e.iCGIPort)
                  , r = new st
                  , o = {
                    type: "GET",
            ...
            ,
            rt.prototype.getDigitalChannelInfo = function(e, t) {
                var n = null
                  , r = {};
                if (this.getDigitalChannel(e, {
                    async: !1,
                    ...
                    I.extend(a, {
                        success: function(e) {
                            ...
                            for (var o = s.$XML(e).find("DynVideoInputChannelStatus", !0), i = 0, a = o.length; a > i; i++) {
                                ...
                                n.push("<id>" + c + "</id>"),
                                n.push("<sourceInputPortDescriptor>"),
                                n.push("<proxyProtocol>" + s.$XML(u).find("adminProtocol").eq(0).text() + "</proxyProtocol>"),
                                n.push("<addressingFormatType>" + s.$XML(u).find("addressingFormatType").eq(0).text() + "</addressingFormatType>"),
                                n.push("<ipAddress>" + s.$XML(u).find("ipAddress").eq(0).text() + "</ipAddress>"),
                                n.push("<managePortNo>" + s.$XML(u).find("adminPortNo").eq(0).text() + "</managePortNo>"),
                                n.push("<srcInputPort>" + s.$XML(u).find("srcInputPort").eq(0).text() + "</srcInputPort>"),
                                n.push("<userName>" + I.escape(s.$XML(u).find("userName").eq(0).text()) + "</userName>"),
                                n.push("<streamType>" + s.$XML(u).find("streamType").eq(0).text() + "</streamType>"),
                                n.push("<online>" + s.$XML(u).find("online").eq(0).text() + "</online>"),
            ...
            ,
            rt.prototype.getZeroChannelInfo = function(e, t) {
                var s = k(this.CGI.getZeroChannelInfo, e.szHttpProtocol, e.szIP, e.iCGIPort)
                  , n = new st
                  , r = {
                    type: "GET",
            ...
            ,
            rt.prototype.getPPPoEStatus = function(e, t) {
                var s = k(this.CGI.getPPPoEStatus, e.szHttpProtocol, e.szIP, e.iCGIPort)
                  , n = new st
                  , r = {
                    type: "GET",
            ...
            ,
            rt.prototype.getUPnPPortStatus = function(e, t) {
                var s = k(this.CGI.getUPnPPortStatus, e.szHttpProtocol, e.szIP, e.iCGIPort)
                  , n = new st
                  , r = {
                    type: "GET",
            ...
            ,
            rt.prototype.getNetworkBond = function(e, t) {
                var s = k(this.CGI.getNetworkBond, e.szHttpProtocol, e.szIP, e.iCGIPort)
                  , n = new st
                  , r = {
                    type: "GET",
            ...
            ,
            rt.prototype.getNetworkInterface = function(e, t) {
                var s = k(this.CGI.getNetworkInterface, e.szHttpProtocol, e.szIP, e.iCGIPort)
                  , n = new st
                  , r = {
                    type: "GET",
            ...
            ,
            rt.prototype.getPortInfo = function(e, t) {
            ...
            ,
            rt.prototype.getStreamChannels = function(e, t) {
                if (0 != e.iAnalogChannelNum)
                    var s = k(this.CGI.getStreamChannels.analog, e.szHttpProtocol, e.szIP, e.iCGIPort);
                else
                    var s = k(this.CGI.getStreamChannels.digital, e.szHttpProtocol, e.szIP, e.iCGIPort);
            ...
            ,
            rt.prototype.getStreamDynChannels = function(e, t) {
            ...
            ,
            rt.prototype.startRealPlay = function(e, t) {
                var s = 100 * t.iChannelID + t.iStreamType
                  , n = ""
                  , r = e.szIP;
                "rtsp://" === t.urlProtocol && (r = W(r)),
            ...
            ,
            rt.prototype.startVoiceTalk = function(e, t) {
                var s = k(this.CGI.startVoiceTalk.open, e.szHttpProtocol, e.szIP, e.iCGIPort, t)
                  , n = k(this.CGI.startVoiceTalk.close, e.szHttpProtocol, e.szIP, e.iCGIPort, t)
                  , r = k(this.CGI.startVoiceTalk.audioData, e.szHttpProtocol, e.szIP, e.iCGIPort, t)
                  , o = u.HWP_StartVoiceTalk(s, n, r, e.szAuth, e.iAudioType);
            ...
            ,
            rt.prototype.ptzAutoControl = function(e, t, s, n) {
                var r = s.iChannelID
                  , o = ""
                  , i = "";
                if (n.iPTZSpeed = 7 > n.iPTZSpeed ? 15 * n.iPTZSpeed : 100,
            ...
            ,
            rt.prototype.ptzControl = function(e, t, s, n) {
                var r = (s.iChannelID,
                "");
                s.bPTZAuto && this.ptzAutoControl(e, !0, s, {
                    iPTZSpeed: 0
            ...
            ,
            rt.prototype.setPreset = function(e, t, s) {
                var n = (t.iChannelID,
                "")
                  , r = "";
            ...
            ,
            rt.prototype.goPreset = function(e, t, s) {
                var n = (t.iChannelID,
                "");
            ...
            ,
            rt.prototype.recordSearch = function(e, n) {
                var r = ""
                  , o = ""
                  , i = n.iChannelID
                  , a = n.szStartTime.replace(" ", "T") + "Z"
            ...
            ,
            rt.prototype.startPlayback = function(e, t) {
                var s = t.iWndIndex
                  , n = t.szStartTime
                  , r = t.szEndTime
                  , o = e.szIP;
            ...
            ,
            rt.prototype.reversePlayback = function(e, t) {
                var s = t.iWndIndex
                  , n = t.szStartTime
                  , r = t.szEndTime
                  , o = e.szIP;
            ...
            ,
            rt.prototype.startDownloadRecord = function(e, t) {
                var s = k(this.CGI.startDownloadRecord, e.szHttpProtocol, e.szIP, e.iCGIPort)
                  , n = "<?xml version='1.0' encoding='UTF-8'?><downloadRequest><playbackURI> " + I.escape(t.szPlaybackURI) + "</playbackURI>" + "</downloadRequest>";
                return u.HWP_StartDownload(s, e.szAuth, t.szFileName, n)
            }
            ,
            rt.prototype.exportDeviceConfig = function(e) {
                var t = k(this.CGI.deviceConfig, e.szHttpProtocol, e.szIP, e.iCGIPort);
                return u.HWP_ExportDeviceConfig(t, e.szAuth, "", 0)
            }
            ,
            rt.prototype.importDeviceConfig = function(e, t) {
                var s = k(this.CGI.deviceConfig, e.szHttpProtocol, e.szIP, e.iCGIPort);
                return u.HWP_ImportDeviceConfig(s, e.szAuth, t.szFileName, 0)
            }
            ,
            rt.prototype.restart = function(e, t) {
                var s = k(this.CGI.restart, e.szHttpProtocol, e.szIP, e.iCGIPort)
                  , n = new st
                  , r = {
                    type: "PUT",
            ...
            ,
            rt.prototype.restore = function(e, t, s) {
                var n = k(this.CGI.restore, e.szHttpProtocol, e.szIP, e.iCGIPort, t)
                  , r = new st
                  , o = {
                    type: "PUT",
            ...
            ,
            rt.prototype.startUpgrade = function(e, t) {
                var s = k(this.CGI.startUpgrade.upgrade, e.szHttpProtocol, e.szIP, e.iCGIPort)
                  , n = k(this.CGI.startUpgrade.status, e.szHttpProtocol, e.szIP, e.iCGIPort);
                return u.HWP_StartUpgrade(s, n, e.szAuth, t.szFileName)
            }
            ,
            rt.prototype.set3DZoom = function(e, t, s, n) {
            ...
            ;
            var ot = function() {};
            ot.prototype._alert = function(e) {
            ...
            function(t) {
                ...
                s.prototype.text = function(t) {
                    return this.elems[this.length - 1] ? t ? (e.DOMParser ? this.elems[this.length - 1].textContent = t : this.elems[this.length - 1].text = t,
                    void 0) : e.DOMParser ? this.elems[this.length - 1].textContent : this.elems[this.length - 1].text : ""
                }
                ,
            ...
            it.prototype.browser = function() {
                var e = /(chrome)[ \/]([\w.]+)/
                  ...
                  , a = e.exec(i) || t.exec(i) || s.exec(i) || n.exec(i) || r.exec(i) || 0 > i.indexOf("compatible") && o.exec(i) || ["unknow", "0"];
            ...
            ,
            it.prototype.loadXML = function(t) {
                if (null == t || "" == t)
                    return null;
                var s = null;
                if (e.DOMParser) {
            ...
            ,
            it.prototype.toXMLStr = function(e) {
                var t = "";
                try {
            ...
            ,
            it.prototype.escape = function(e) {
                return e.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;")
            }
            ,
            it.prototype.dateFormat = function(e, t) {
                var s = {
                    "M+": e.getMonth() + 1,
                    "d+": e.getDate(),
                    "h+": e.getHours(),
                ...
                for (var n in s)
                    RegExp("(" + n + ")").test(t) && (t = t.replace(RegExp.$1, 1 == RegExp.$1.length ? s[n] : ("00" + s[n]).substr(("" + s[n]).length)));
                return t
            }
            ,
            it.prototype.Base64 = {
                ...
                encode: function(e) {
                    var t, s, n, r, o, i, a, u = "", c = 0;
                    for (e = it.prototype.Base64._utf8_encode(e); e.length > c; )
                        t = e.charCodeAt(c++),
                        s = e.charCodeAt(c++),
                        n = e.charCodeAt(c++),
                        r = t >> 2,
                        ...
                        u = u + this._keyStr.charAt(r) + this._keyStr.charAt(o) + this._keyStr.charAt(i) + this._keyStr.charAt(a);
                    return u
                },
                decode: function(e) {
                    var t, s, n, r, o, i, a, u = "", c = 0;
                    ...
                    return u = it.prototype.Base64._utf8_decode(u)
                },
                ...
                _utf8_decode: function(e) {
                    for (var t = "", s = 0, n = c1 = c2 = 0; e.length > s; )
                        n = e.charCodeAt(s),
            ...
            t.getIntegerBits = function(e, s, n) {
                ...
                for (a = Math.floor(s / 4); Math.floor(n / 4) >= a; a++)
                    i += o[a] && "" != o[a] ? o[a] : "0";
                return i
            }
            ,
            ...
            d = new ot,
            I = new it;
            var at = I.dateFormat(new Date, "yyyyMMddhhmmss");
            if (o = "webVideoCtrl" + at,
            i = "webVideoCtrl" + at,
            "object" != typeof e.attachEvent && I.browser().msie) {
                var ut = "<script for=" + o + " event='GetSelectWndInfo(SelectWndInfo)'>GetSelectWndInfo(SelectWndInfo);</script>";
                ut += "<script for=" + o + " event='ZoomInfoCallback(szZoomInfo)'>ZoomInfoCallback(szZoomInfo);</script>",
                ut += "<script for=" + o + "  event='GetHttpInfo(lID, lpInfo, lReverse)'>GetHttpInfo(lID, lpInfo, lReverse);</script>",
                ut += "<script for=" + o + "  event='PluginEventHandler(iEventType, iParam1, iParam2)'>PluginEventHandler(iEventType, iParam1, iParam2);</script>",
                ut += "<script for=" + o + "  event='RemoteConfigInfo(lID)'>RemoteConfigInfo(lID);</script>",
                document.write(ut)
            }
            return this
        }()
