...
public interface ${simpleIServiceName} {
	 ...
	 * @return
	 */
	Json deleteByPrimaryKey(Long ${pid}) throws Exception;
	 ...
	 * @return
	 */
	${simpleclassName} selectByPrimaryKey(Long ${pid}) throws Exception;
     ...
     * @return
     */
	String select${simpleclassName}ByPage(${simpleclassName} record, PageUtil page) throws Exception;
