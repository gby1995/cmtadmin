...
public class ${simpleServiceImplName} implements ${simpleIServiceName} {
	 ...
	 * @return
	 */
	public Json deleteByPrimaryKey(Long ${pid}) throws Exception {
		Json json = new Json();
		int result = -1;
	 ...
	 * @return
	 */
	public ${simpleclassName} selectByPrimaryKey(Long ${pid}) throws Exception{
     ...
     * @return
     */
	public String select${simpleclassName}ByPage(${simpleclassName} record, PageUtil page) throws Exception{
